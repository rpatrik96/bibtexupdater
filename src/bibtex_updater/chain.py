...
def _bridge_check_args(update_args: Any) -> Any:
    ...
    check_args.openreview_username = getattr(update_args, "openreview_username", None)
...
def _bridge_resolve_args(check_args: Any) -> Any:
    ...
    resolve_args.openreview_username = getattr(check_args, "openreview_username", None)
